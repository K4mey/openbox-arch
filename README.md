...
## Setup basic
sudo pacman -S nvidia nvidia-utils nvidia-settings lib32-nvidia-utils git xorg xorg-xinit sddm openbox xterm termite firefox pcmanfm tint2 nitrogen geany pcmanfm lxappearance
