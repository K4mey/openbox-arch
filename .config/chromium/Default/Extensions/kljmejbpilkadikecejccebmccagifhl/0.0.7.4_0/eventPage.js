...
function initialize(){
	...
	if(localStorage.getItem("SauceNAO-URL") === null) localStorage["SauceNAO-URL"] = "http://saucenao.com/search.php?db=999&url=";
	...
	if(localStorage.getItem("IQDB-URL") === null) localStorage["IQDB-URL"] = "http://iqdb.org/?url=";
	...
	if(localStorage.getItem("TinEye-URL") === null) localStorage["TinEye-URL"] = "http://tineye.com/search/?url=";
	...
	if(localStorage.getItem("Google-URL") === null) localStorage["Google-URL"] = "http://www.google.com/searchbyimage?image_url=";
	...
	if(localStorage.getItem("Other1-URL") === null) localStorage["Other1-URL"] = "http://other-site-1";
	...
	if(localStorage.getItem("Other2-URL") === null) localStorage["Other2-URL"] = "http://other-site-2";
	...
	if(localStorage.getItem("Other3-URL") === null) localStorage["Other3-URL"] = "http://other-site-3";
	...
	if(localStorage.getItem("Other4-URL") === null) localStorage["Other4-URL"] = "http://other-site-4";
	...
	if(localStorage.getItem("Other5-URL") === null) localStorage["Other5-URL"] = "http://other-site-5";
	...
	if(localStorage.getItem("Other6-URL") === null) localStorage["Other6-URL"] = "http://other-site-6";
